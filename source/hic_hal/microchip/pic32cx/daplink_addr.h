...
#define DAPLINK_ROM_START               0x01000000
#define DAPLINK_ROM_SIZE                0x00200000

#define DAPLINK_RAM_START               0x20000000
#define DAPLINK_RAM_SIZE                0x00080000

/* ROM sizes */

#define DAPLINK_ROM_BL_START            0x01000000
#define DAPLINK_ROM_BL_SIZE             0x0000E000

#define DAPLINK_ROM_CONFIG_ADMIN_START  0x0100E000
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000000

#define DAPLINK_ROM_IF_START            0x0100E000
#define DAPLINK_ROM_IF_SIZE             0x001F0000

#define DAPLINK_ROM_CONFIG_USER_START   0x011FE000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00002000

/* RAM sizes */

#define DAPLINK_RAM_APP_START           0x20000000
#define DAPLINK_RAM_APP_SIZE            0x0007FF00

#define DAPLINK_RAM_SHARED_START        0x2007FF00
